...
resource "aws_route53_record" "loganmarchione_com_dmarc" {
  ...
  ttl     = "3600"
  records = [
    "v=DMARC1; p=quarantine; sp=quarantine; rua=mailto:re+dviosnr2n0b@dmarc.postmarkapp.com; aspf=r;"
  ]
}
...
module "iam_github_oidc_role_loganmarchione_com" {
  source = "github.com/terraform-aws-modules/terraform-aws-iam//modules/iam-role?ref=v6.2.3"
